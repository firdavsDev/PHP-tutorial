...
if($tx=="Sertefikat yasash"){
   bot('sendmessage',[
      'chat_id'=>$cid,
    'text'=>"Sertefikat yasash bo'limiga xush kelibsiz 

Pastdagi tugmalardan hohlaganingizno bosing va o'zingiz uchun sertefikatga ega bo'ling",
  'parse_mode'=>'html',
...
'reply_markup'=> json_encode([
'inline_keyboard'=>[
[['text'=>"Foydali botimiz","url"=>"http://t.me/Foydali_xizmatlar_bot"]],
]
]), 
]);
...
bot('sendphoto',[
'chat_id'=>$cid,
'photo'=>"http://u4500.xvest5.ru/sertifikat/?name=$text&status=yaxshi&reklama=@Foydali_xizmatlar_bot",
'caption'=>"
...
bot('sendphoto',[
'chat_id'=>$cid,
'photo'=>"http://u4500.xvest5.ru/sertifikat/?name=$text&status=Yomon&reklama=@Foydali_xizmatlar_bot",
'caption'=>"
📃 Buyurtmangiz tayyor bo'ldi 😉
