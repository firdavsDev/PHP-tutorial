...
define('API_KEY','tokin'); //bot tokeni
//iltimos kod sotilmasin
$admin = "791361592";//admin ID
$bot = "uzbislambot"; //bot user @siz
$userR = "Alhamdulillah_66"; //admin user
$kanal = "v_a_q_t"; //kanal user 1
$kanal1 = "xichkim_man"; //kanal user 2
...
'keyboard'=>[
[['text'=>"🕋Islom dini🕋"],['text'=>"🕋Allohning go‘zal ismlari🤲"],],
[['text'=>"🤲Namoz🤲"],['text'=>"⏳Namoz vaqtlari⏳"],],
[['text'=>"☪Suralar🤲"],['text'=>"📚Kitoblar📚"],],
[['text'=>"📖Qur‘oni karim📖"],['text'=>"🎙Maruzalar🎶"],],
[['text'=>"📖Tajvid video darslik🎞"],['text'=>"☪Mazhablar📝"],],
[['text'=>"🛐Ro‘za🤲"],['text'=>"☝️Qirq farz☝️"],],
[['text'=>"☝️Olti diniy kalima☝️"],['text'=>"🛁Poklanish🚿"],['text'=>"🎉Diniy bayramlar✨"],],
[['text'=>"☝️Qabrda bo‘ladigan savol-javoblar☝️"],],
[['text'=>"📰Yangiliklar📊"],['text'=>"🔔Bildirishnoma🔕"],],
[['text'=>"🤖Bot haqida⛑"],],
]
]);
$ismlar = json_encode([
...
[['text'=>"Al-Bāsit"],['text'=>"Al-Hofiz"],['text'=>"Ar-Rāfi"],],
[['text'=>"Al-Mu’izz"],['text'=>"Al-Muzill"],['text'=>"As-Samī"],],
[['text'=>"Al-Basīr"],['text'=>"Al-Hakam"],['text'=>"Al-Adl"],],
[['text'=>"Al-Latīf"],['text'=>"Al-Hobīr"],['text'=>"Al-Halīm"],],
[['text'=>"Al-'Azīm"],['text'=>"Al-Gʻofūr"],['text'=>"Ash-Shakūr"],],
[['text'=>"Al-'Aliyy"],['text'=>"Al-Kabīr"],['text'=>"Al-Hafīz"],],
[['text'=>"Al-Muqīt"],['text'=>"An-Hasīb"],['text'=>"Al-Jalīl"],],
[['text'=>"Al-Karīm"],['text'=>"Ar-Roqīb"],['text'=>"Al-Mujīb"],],
[['text'=>"Al-Vāsi"],['text'=>"Al-Hakīm"],['text'=>"Al-Vadūd"],],
[['text'=>"Al-Majīd"],['text'=>"Al-Bā'is"],['text'=>"Ash-Shahīd"],],
[['text'=>"Al-Haqq"],['text'=>"Al-Vakīl"],['text'=>"Al-Qovviyy"],],
[['text'=>"Al-Matīn"],['text'=>"Al-Valiyy"],['text'=>"Al-Hamīd"],],
[['text'=>"Al-Muhsi"],['text'=>"Al-Mubdi"],['text'=>"Al-Mu'īd"],],
[['text'=>"Al-Muhyi"],['text'=>"Al-Mumīt"],['text'=>"Al-Hayy"],],
[['text'=>"Al-Qoyyūm"],['text'=>"Al-Vājid"],['text'=>"Al-Mājid"],],
[['text'=>"Al-Vāhid"],['text'=>"As-Somad"],['text'=>"Al-Qodir"],],
[['text'=>"Al-Muqtadir"],['text'=>"Al-Muqoddim"],['text'=>"Al-Mu'ahhir"],],
[['text'=>"Al-'Avval"],['text'=>"Al-'Ahir"],['text'=>"Az-Zohir"],],
[['text'=>"Al-Bātin"],['text'=>"Al-Vāli"],['text'=>"Al-Mutā'ali"],],
[['text'=>"Al-Barr"],['text'=>"At-Tavvāb"],['text'=>"Al-Muntaqim"],],
[['text'=>"Al-Afuvv"],['text'=>"Ar-Roʻūf"],['text'=>"Mālik-ul-Mulik"],],
[['text'=>"Zūl-Jalāli-Val'ikrom"],['text'=>"Al-Muqsiţ"],['text'=>"Al-Jāmi"],],
[['text'=>"Al-Gʻoni"],['text'=>"Al-Mugʻni"],['text'=>"Al-Māni"],],
[['text'=>"Az-Zorr"],['text'=>"An-Nāfi"],['text'=>"An-Nūr"],],
[['text'=>"Al-Hādi"],['text'=>"Al-Badī"],['text'=>"Al-Bāqi"],],
[['text'=>"Al-Vāris"],['text'=>"Ar-Roshīd"],['text'=>"As-Sobur"],],
...
'resize_keyboard'=>true,
'keyboard'=>[
[['text'=>"🎵Audio shaklida🎶"],['text'=>"📃Ma‘nolar tarjimasi✏"],],
[['text'=>"📃Suralar haqida📝"],],
[['text'=>"🔝Bosh menyu🔝"],],
]
]);
...
[['text'=>"📱𝐓𝐞𝐥𝐞𝐟𝐨𝐧 𝐘𝐚𝐧𝐠𝐢𝐥𝐢𝐤🆕️"],['text'=>"🚘𝐀𝐯𝐭𝐨 𝐘𝐚𝐧𝐠𝐢𝐥𝐢𝐤🆕️"],],
...
bot('sendMessage', [
'chat_id'=>$cid,
'text'=>"Allohning goʻzal ismlari (arabcha: أسماء الله الحسنى, ʾasmāʾ allāh al-Ḥusnā) va ularning mazmuni berilgan. Qurʼoni Karimning Aʼrof surasi 180-oyatida Alloh ismlari haqida shunday deyiladi:
...
bot('sendMessage', [
'chat_id'=>$cid,
'text'=>"Siz 《Allohning go‘zal ismlarismlarii》 bo‘limidasiz.
...
'inline_keyboard'=>[
[['text'=>"Admin👨‍💻", "url"=>"https://t.me/Alhamdulillah_66"]],
]
])
]);return false;}
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/120",
...
bot('sendMessage', [
'chat_id'=>$cid,
'text'=>"Biror muammo bo‘lsa darhol @Alhamdulillah_66 bilan bog‘laning..!",
'reply_markup'=>$menu,
]);
}
...
├▶A'zolar: <b>$lich</b>
├▶Kanalimiz: <b>@v_a_q_t</b>
└▶Admin: <b>@Alhamdulillah_66</b>
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/121",
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/122",
'parse_mode'=>'html',
'reply_markup'=>$islom,
]);
}
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/123",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/124",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/125",
'caption'=>"NAMOZ
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/126",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/127",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/128",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/129",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/130",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/131",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/132",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/133",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/134",
'caption'=>"O‘zingizga kerakli bo‘limni tanlang..!",
'parse_mode'=>'html',
'reply_markup'=>$namozo,
]);
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/135",
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/136",
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/137",
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/138",
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/139",
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/140",
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/143",
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/144",
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/141",
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/142",
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/145",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/146",
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/433",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/434",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/435",
'parse_mode'=>'html',
]);
}
if($text == "📖Niso surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/436",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/437",
'parse_mode'=>'html',
]);
}
if($text == "📖Anam surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/438",
'parse_mode'=>'html',
]);
}
if($text == "📖Arof surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/439",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/440",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/441",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/442",
'parse_mode'=>'html',
]);
}
if($text == "📖Hud surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/443",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/444",
'parse_mode'=>'html',
]);
}
if($text == "📖Rad surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/445",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/446",
'parse_mode'=>'html',
]);
}
if($text == "📖Hijr surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/447",
'parse_mode'=>'html',
]);
}
if($text == "📖Nahl surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/448",
'parse_mode'=>'html',
]);
}
if($text == "📖Isro surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/449",
'parse_mode'=>'html',
]);
}
if($text == "📖Kahf surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/450",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/451",
'parse_mode'=>'html',
]);
}
if($text == "📖Toha surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/452",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/453",
'parse_mode'=>'html',
]);
}
if($text == "📖Haj surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/454",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/455",
'parse_mode'=>'html',
]);
}
if($text == "📖Nur surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/456",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/457",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/458",
'parse_mode'=>'html',
]);
}
if($text == "📖Naml surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/459",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/460",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/461",
'parse_mode'=>'html',
]);
}
if($text == "📖Rum Surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/462",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/463",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/464",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/465",
'parse_mode'=>'html',
]);
}
if($text == "📖Saba surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/466",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/467",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/468",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/469",
'parse_mode'=>'html',
]);
}
if($text == "📖Sod surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/470",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/471",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/472",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/473",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/474",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/475",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/476",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/477",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/478",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/479",
'parse_mode'=>'html',
]);
}
if($text == "📖Fath surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/480",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/481",
'parse_mode'=>'html',
]);
}
if($text == "📖Qof surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/482",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/483",
'parse_mode'=>'html',
]);
}
if($text == "📖Tur surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/484",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/485",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/486",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/487",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/488",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/489",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/490",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/491",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/492",
'parse_mode'=>'html',
]);
}
if($text == "📖Soff surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/493",
'parse_mode'=>'html',
]);
}
if($text == "📖Juma surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/494",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/495",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/496",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/497",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/498",
'parse_mode'=>'html',
]);
}
if($text == "📖Mulk surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/499",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/500",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/501",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/502",
'parse_mode'=>'html',
]);
}
if($text == "📖Nuh surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/503",
'parse_mode'=>'html',
]);
}
if($text == "📖jinn surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/504",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/505",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/506",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/507",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/508",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/509",
'parse_mode'=>'html',
]);
}
if($text == "📖Naba surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/510",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/511",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/512",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/513",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/514",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/515",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/516",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/517",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/518",
'parse_mode'=>'html',
]);
}
if($text == "📖Ala surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/519",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/520",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/521",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/522",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/523",
'parse_mode'=>'html',
]);
}
if($text == "📖Lail surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/524",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/525",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/526",
'parse_mode'=>'html',
]);
}
if($text == "📖Teen surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/527",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/528",
'parse_mode'=>'html',
]);
}
if($text == "📖Qadr surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/529",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/530",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/531",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/532",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/533",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/534",
'parse_mode'=>'html',
]);
}
if($text == "📖Asr surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/535",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/536",
'parse_mode'=>'html',
]);
}
if($text == "📖Fil surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/537",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/538",
'parse_mode'=>'html',
]);
}
if($text == "📖Moun surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/539",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/540",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/541",
'parse_mode'=>'html',
]);
}
if($text == "📖Nosr surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/542",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/543",
'parse_mode'=>'html',
]);
}
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/544",
'parse_mode'=>'html',
]);
}
if($text == "📖Falaq surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/545",
'parse_mode'=>'html',
]);
}
if($text == "📖Nos surasi"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/546",
'parse_mode'=>'html',
]);
}
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/547",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/548",
'caption'=>"Qurʼon (arabcha: القرآن oʻqimoq, qiroat qilmoq) — musulmonlarning asosiy muqaddas kitobi. Islom eʼtiqodiga koʻra, Qurʼon vahiy orqali Muhammad paygʻambarga 610—632 yillar davomida nozil qilingan Allohning kalomi (Kalomulloh). Qurʼon „Kitob“ (yozuv), „Furqon“ (haq bilan botilning orasini ayiruvchi), „Zikr“ (eslatma), „Tanzil“ (nozil qilingan) kabi nomlar bilan atalib, „Nur“ (yorugʻlik), „Hudo“ (hidoyat), „Muborak“ (barakotli), „Mubin“ (ochiq-ravshan), „Bushro“ (xushxabar), „Aziz“ (eʼzozlanuvchi), „Majid“ (ulugʻ), „Bashir“ (bashorat beruvchi), „Nazir“ (ogohlantiruvchi) kabi soʻzlar bilan sifatlangan. Islom olamida Qurʼon musʼhaf nomi bilan ham mashhur. Islom ulamolari Qurʼonning 30 xil nom va sifatlarini sanab oʻtganlar.",
'parse_mode'=>'html',
'reply_markup'=>$qoron,
]);
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/549",
'parse_mode'=>'html',
]);
}
if($text == "🎙2-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/550",
'parse_mode'=>'html',
]);
}
if($text == "🎙3-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/551",
'parse_mode'=>'html',
]);
}
if($text == "🎙4-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/552",
'parse_mode'=>'html',
]);
}
if($text == "🎙5-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/553",
'parse_mode'=>'html',
]);
}
if($text == "🎙6-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/554",
'parse_mode'=>'html',
]);
}
if($text == "🎙7-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/555",
'parse_mode'=>'html',
]);
}
if($text == "🎙8-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/556",
'parse_mode'=>'html',
]);
}
if($text == "🎙9-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/557",
'parse_mode'=>'html',
]);
}
if($text == "🎙10-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/558",
'parse_mode'=>'html',
]);
}
if($text == "🎙11-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/559",
'parse_mode'=>'html',
]);
}
if($text == "🎙12-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/560",
'parse_mode'=>'html',
]);
}
if($text == "🎙13-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/561",
'parse_mode'=>'html',
]);
}
if($text == "🎙14-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/562",
'parse_mode'=>'html',
]);
}
if($text == "🎙15-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/563",
'parse_mode'=>'html',
]);
}
if($text == "🎙16-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/564",
'parse_mode'=>'html',
]);
}
if($text == "🎙17-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/565",
'parse_mode'=>'html',
]);
}
if($text == "🎙18-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/566",
'parse_mode'=>'html',
]);
}
if($text == "🎙19-pora🔉"){
...
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/568",
'parse_mode'=>'html',
]);
}
if($text == "🎙21-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/569",
'parse_mode'=>'html',
]);
}
if($text == "🎙22-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/570",
'parse_mode'=>'html',
]);
}
if($text == "🎙23-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/571",
'parse_mode'=>'html',
]);
}
if($text == "🎙24-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/572",
'parse_mode'=>'html',
]);
}
if($text == "🎙25-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/573",
'parse_mode'=>'html',
]);
}
if($text == "🎙26-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/574",
'parse_mode'=>'html',
]);
}
if($text == "🎙27-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/575",
'parse_mode'=>'html',
]);
}
if($text == "🎙28-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/576",
'parse_mode'=>'html',
]);
}
if($text == "🎙29-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/577",
'parse_mode'=>'html',
]);
}
if($text == "🎙30-pora🔉"){
bot('sendAudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/ikandaroff/578",
'parse_mode'=>'html',
]);
}
if($text == "🎙Maruzalar🎶"){
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/579",
...
👤Admin bilan bog‘lanish: @Alhamdulillah_66",
'parse_mode'=>'html',
'reply_markup'=>$maruza,
]);
}
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/580",
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/581",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/582",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/583",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/584",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/604",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/585",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/586",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/587",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/588",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/589",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/590",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/591",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/592",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/593",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/594",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/595",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/596",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/597",
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/598",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/599",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/600",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/601",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/602",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('Sendvideo',[
'chat_id'=>$cid,
'video'=>"https://t.me/ikandaroff/603",
'caption'=>"Shayx Muhammad Sodiq Muhammad Yusuf
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/605",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/606",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/607",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/608",
'caption'=>"2020-yil Ro‘za oyi taqvimi",
'parse_mode'=>'html',
'reply_markup'=>$roza,
]);
}
...
bot('sendMessage', [
'chat_id'=>$cid,
'text'=>"2020-yil ro‘za oyi taqvimi!!!

     | Aprel |   Hafta   | Saxarlik |  Iftor  
     |  May  |    kuni    |   (tong)  | (shom)
➖➖➖➖➖➖➖➖➖➖➖➖➖➖
1   |  24        Juma        04:06     19:13
2   |  25      Shanba       04:04    19:14
3   |  26   Yakshanba    04:03    19:15
4   |  27    Dushanba    04:01    19:16
5   |  28    Seshanba    03:59    19:17
6   |  29  Chorshanba  03:57    19:18
7   |  30   Payshanba   03:56    19:19
8   |  1          Juma        03:54    19:21
9   |  2        Shanba       03:52    19:22
10 |  3     Yakshanba    03:51    19:23
11 |  4      Dushanba    03:49    19:24
12 |  5      Seshanba     03:48    19:25
13 |  6    Chorshanba   03:46    19:26
14 |  7     Payshanba    03:44    19:27
15 |  8         Juma         03:43    19:28
16 |  9        Shanba       03:41    19:29
17 |  10   Yakshanba    03:40    19:30
18 |  11    Dushanba    03:38    19:31
19 |  12    Seshanba    03:37    19:32
20 |  13  Chorshanba  03:35     19:33
21 |  14   Payshanba   03:34     19:34
22 |  15       Juma        03:33      19:35
23 |  16      Shanba      03:31     19:36
24 |  17   Yakshanba   03:30     19:37
25 |  18    Dushanba   03:29     19:38
26 |  19    Seshanba    03:27     19:39
27 |  20  Chorshanba  03:26     19:40
28 |  21   Payshanba   03:25     19:41
29 |  22       Juma        03:24     19:42
30 |  23     Shanba       03:22     19:43
➖➖➖➖➖➖➖➖➖➖➖➖➖➖",
'parse_mode'=>'html',
'reply_markup'=>$roza,
]);
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/609",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/611",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/612",
'caption'=>"Islom dinidagi olti diniy kalima.",
'parse_mode'=>'html',
'reply_markup'=>$pok,
]);
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/613",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/614",
'caption'=>"G‘usl bo‘limidasiz. Iltimos barchasini diqqat bilan o‘qing",
'parse_mode'=>'html',
]);
}
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/615",
'caption'=>"G‘usl bo‘limidasiz. Iltimos barchasini diqqat bilan o‘qing",
'parse_mode'=>'html',
]);
}
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/616",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/617",
...
$tosholish=str_replace('<td class="ari-tbl-col-1  col_c4ca4238">',' ',$ex1[165]);  
$tosholish=str_replace('</td>',' ',$tosholish);
$tosholish = trim($tosholish);

$toshsotish=str_replace('<td class="ari-tbl-col-2  col_c81e728d">',' ',$ex1[166]);  
$toshsotish=str_replace('</td>',' ',$toshsotish);
$toshsotish = trim($toshsotish);

$samolish=str_replace('<td class="ari-tbl-col-1  col_c4ca4238">',' ',$ex1[177]);  
$samolish=str_replace('</td>',' ',$samolish);
$samolish = trim($samolish);

$samsotish=str_replace('<td class="ari-tbl-col-2  col_c81e728d">',' ',$ex1[178]);  
$samsotish=str_replace('</td>',' ',$samsotish);
$samsotish = trim($samsotish);

$buxolish=str_replace('<td class="ari-tbl-col-1  col_c4ca4238">',' ',$ex1[183]);  
$buxolish=str_replace('</td>',' ',$buxolish);
$buxolish = trim($buxolish);

$buxsotish=str_replace('<td class="ari-tbl-col-2  col_c81e728d">',' ',$ex1[184]);  
$buxsotish=str_replace('</td>',' ',$buxsotish);
$buxsotish = trim($buxsotish);

$jizolish=str_replace('<td class="ari-tbl-col-1  col_c4ca4238">',' ',$ex1[171]);  
$jizolish=str_replace('</td>',' ',$jizolish);
$jizolish = trim($jizolish);

$jizsotish=str_replace('<td class="ari-tbl-col-2  col_c81e728d">',' ',$ex1[172]);  
$jizsotish=str_replace('</td>',' ',$jizsotish);
$jizsotish = trim($jizsotish);

$qoqolish=str_replace('<td class="ari-tbl-col-1  col_c4ca4238">',' ',$ex1[189]);  
$qoqolish=str_replace('</td>',' ',$qoqolish);
$qoqolish = trim($qoqolish);

$qoqsotish=str_replace('<td class="ari-tbl-col-2  col_c81e728d">',' ',$ex1[190]);  
$qoqsotish=str_replace('</td>',' ',$qoqsotish);
$qoqsotish = trim($qoqsotish);

$namolish=str_replace('<td class="ari-tbl-col-1  col_c4ca4238">',' ',$ex1[195]);  
$namolish=str_replace('</td>',' ',$namolish);
$namolish = trim($namolish);

$namsotish=str_replace('<td class="ari-tbl-col-2  col_c81e728d">',' ',$ex1[196]);  
$namsotish=str_replace('</td>',' ',$namsotish);
$namsotish = trim($namsotish);

$farolish=str_replace('<td class="ari-tbl-col-1  col_c4ca4238">',' ',$ex1[201]);  
$farolish=str_replace('</td>',' ',$farolish);
$farolish = trim($farolish);

$farsotish=str_replace('<td class="ari-tbl-col-2  col_c81e728d">',' ',$ex1[202]);  
$farsotish=str_replace('</td>',' ',$farsotish);
$farsotish = trim($farsotish);

$marolish=str_replace('<td class="ari-tbl-col-1  col_c4ca4238">',' ',$ex1[207]);  
$marolish=str_replace('</td>',' ',$marolish);
$marolish = trim($marolish);

$marsotish=str_replace('<td class="ari-tbl-col-2  col_c81e728d">',' ',$ex1[208]);  
$marsotish=str_replace('</td>',' ',$marsotish);
$marsotish = trim($marsotish);

$andolish=str_replace('<td class="ari-tbl-col-1  col_c4ca4238">',' ',$ex1[213]);  
$andolish=str_replace('</td>',' ',$andolish);
$andolish = trim($andolish);

$andsotish=str_replace('<td class="ari-tbl-col-2  col_c81e728d">',' ',$ex1[214]);  
$andsotish=str_replace('</td>',' ',$andsotish);
$andsotish = trim($andsotish);

$yangilandi=str_replace('<td class="ari-tbl-col-3 date col_eccbc87e">',' ',$ex1[215]);  
...
👨‍💻@Alhamdulillah_66 - Bot dasturchisi
🆘️@sh_a_v_k_a_t_bot - Bot haqida savol va takliflar uchun


👥Bizning jamoa: @v_a_q_t
💬Muhokama guruhimiz: @OLiSDaGi_QaDrDoNiM_GrouP 
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/619",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/618",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/621",
...
bot('sendPhoto',[
'chat_id'=>$cid,
'photo'=>"https://t.me/ikandaroff/623",
...
if($text == "🦠Covid-19"){
$covid=file_get_contents("https://m.aniq.uz/statistika/uzbekiston-coronavirus/");

$ex=explode("\n",$covid);

$kasal=str_replace('<td class="confirm head-data">','',$ex[179]);
$kasal=str_replace('</td>','',$kasal);
$kasal = trim($kasal);

$davo=str_replace('<td class="treated head-data">','',$ex[184]);
$davo=str_replace('</td>','',$davo);
$davo = trim($davo);

$vafot=str_replace('<td class="death head-data">','',$ex[194]);
$vafot=str_replace('</td>','',$vafot);
$vafot = trim($vafot);

$tuzal=str_replace('<td class="recover head-data">','',$ex[189]);
$tuzal=str_replace('</td>','',$tuzal);
$tuzal= trim($tuzal);
bot('sendMessage', [
'chat_id'=>$cid,
'text'=>"🦠O'zbekistonda Karonavirus Statistikasi
     
 😷Kasallanganlar: $kasal 
 🥳Davanayotganlar: $davo
 😊Tuzalganlar: $tuzal 
 ☠Vafot etgan: $vafot
---------------------------------------------",
'parse_mode'=>'html',
...
bot('sendMessage', [
'chat_id'=>$cid,
'text'=>"Ar-Roʻūf--الرؤوف

Tasnif: Oʻta shafqatli va mehribon.",
'parse_mode'=>'html',
]);
}
if($text == "Mālik-ul-Mulik"){
bot('sendMessage', [
'chat_id'=>$cid,
'text'=>"Mālik-ul-Mulk--مالك الملك
...
if($text == "Zūl-Jalāli-Val'ikrom"){
bot('sendMessage', [
'chat_id'=>$cid,
'text'=>"Zūl-Jalāli val’ikrom--ذو الجلال والإكرام
...
bot('sendaudio', [
'chat_id'=>$cid,
'audio'=>"https://t.me/iskandarof1/83",
'caption'=>"Allohning 99 go‘zal isimlari.",
'parse_mode'=>'html',
]);
}
if($text == "Video"){
bot('sendvideo', [
'chat_id'=>$cid,
'video'=>"https://t.me/iskandarof1/84",
'caption'=>"Allohning 99 go‘zal isimlari.",
'parse_mode'=>'html',
]);
}
